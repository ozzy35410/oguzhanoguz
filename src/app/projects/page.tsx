...
const kthAdaptiveSignalProjects = [
  {
...
const kthDigitalCommunicationsProjects = [
  {
...
export default function Projects() {
  ...
  const [kthDigitalCommunicationsExpanded, setKthDigitalCommunicationsExpanded] = useState(false)
        ...
        <section>
          ...
          {kthExpanded && (
            <div className="mt-6 space-y-6">
              ...
              <div>
                <button
                  onClick={() => setKthPatternRecognitionExpanded(!kthPatternRecognitionExpanded)}
                  className="w-full flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-700/50 transition-colors"
                >
                  <h3 className="text-xl font-semibold text-zinc-700 dark:text-zinc-200">
                  ...
                  <ChevronDownIcon
                    className={`h-5 w-5 text-zinc-500 transition-transform ${
                      kthPatternRecognitionExpanded ? 'rotate-180' : ''
                    }`}
                  />
                </button>

                {kthPatternRecognitionExpanded && (
                  <div className="mt-4">
                    <ul role="list" className="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
                      {kthPatternRecognitionProjects.map((project) => (
                        <Card as="li" key={project.name}>
                          <div className="flex items-center gap-2 mb-2">
                            <Card.Link href={`/projects/${project.name.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/-+$/, '')}`}>
                              <h4 className="text-base font-semibold text-zinc-800 dark:text-zinc-100">
              ...
              <div>
                <button
                  onClick={() => setKthAdaptiveExpanded(!kthAdaptiveExpanded)}
                  className="w-full flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-700/50 transition-colors"
                >
                  <h3 className="text-xl font-semibold text-zinc-700 dark:text-zinc-200">
                  ...
                  <ChevronDownIcon
                    className={`h-5 w-5 text-zinc-500 transition-transform ${
                      kthAdaptiveExpanded ? 'rotate-180' : ''
                    }`}
                  />
                </button>
                ...
                {kthAdaptiveExpanded && (
                  <div className="mt-4">
                    <ul role="list" className="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
                      {kthAdaptiveSignalProjects.map((project) => (
                        <Card as="li" key={project.name}>
                          <div className="flex items-center gap-2 mb-2">
                            <Card.Link href={`/projects/${project.name.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/-+$/, '')}`}>
                              <h4 className="text-base font-semibold text-zinc-800 dark:text-zinc-100">
              ...
              {/* EQ2321 Speech and Audio Processing Course Button */}
              <div>
                <button
                  onClick={() => setKthSpeechAudioExpanded(!kthSpeechAudioExpanded)}
                  className="w-full flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-700/50 transition-colors"
                >
                  <h3 className="text-xl font-semibold text-zinc-700 dark:text-zinc-200">
                  ...
                  <ChevronDownIcon
                    className={`h-5 w-5 text-zinc-500 transition-transform ${
                      kthSpeechAudioExpanded ? 'rotate-180' : ''
                    }`}
                  />
                </button>

                {kthSpeechAudioExpanded && (
                  <div className="mt-4">
                    <ul role="list" className="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
                      {kthSpeechAudioProjects.map((project) => (
                        <Card as="li" key={project.name}>
                          <div className="flex items-center gap-2 mb-2">
                            <Card.Link href={`/projects/${project.name.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/-+$/, '')}`}>
                              <h4 className="text-base font-semibold text-zinc-800 dark:text-zinc-100">
              ...
              {/* EQ2310 Digital Communications Course Button */}
              <div>
                <button
                  onClick={() => setKthDigitalCommunicationsExpanded(!kthDigitalCommunicationsExpanded)}
                  className="w-full flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-700/50 transition-colors"
                >
                  <h3 className="text-xl font-semibold text-zinc-700 dark:text-zinc-200">
                  ...
                  <ChevronDownIcon
                    className={`h-5 w-5 text-zinc-500 transition-transform ${
                      kthDigitalCommunicationsExpanded ? 'rotate-180' : ''
                    }`}
                  />
                </button>

                {kthDigitalCommunicationsExpanded && (
                  <div className="mt-4">
                    <ul role="list" className="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
                      {kthDigitalCommunicationsProjects.map((project) => (
                        <Card as="li" key={project.name}>
                          <div className="flex items-center gap-2 mb-2">
                            <Card.Link href={`/projects/${project.name.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/-+$/, '')}`}>
                              <h4 className="text-base font-semibold text-zinc-800 dark:text-zinc-100">
